...
void Guide::Init(AquaEngine::Command& command)
{
    auto& tex_manager
    ...
    m_rectangle->CreateShaderResourceView(std::move(tex_range), tex_manager);
    ...
    vs.Load(L"shaders/ui1.hlsl", "vs", "vs_5_0");
    ps.Load(L"shaders/ui1.hlsl", "ps", "ps_5_0");
